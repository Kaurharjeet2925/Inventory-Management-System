...
export default function Register({ onSuccess, onSwitch }: RegisterProps) {
  ...
  return (
    <>
      ...
      <Card.Body>
        <h3 className="text-center mb-3" style={{ fontSize: '20px', fontWeight: 700 }}>Create Account</h3>
        <p className="text-center text-muted mb-3" style={{ fontSize: '13px' }}>Sign up to start managing your inventory</p>

        <Form onSubmit={handleSubmit}>
          {/* Name */}
          <div className="mb-3">
            <Form.Label style={{ fontSize: '13px', fontWeight: 600 }}>Name</Form.Label>
            <InputGroup>
              <InputGroup.Text>
